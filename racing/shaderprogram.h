...
public:
	...
	//void useBasicLight(Light* light);
	void useDirectionalLight(DirectionalLight* light[], int lightCount);
	void usePointLight(PointLight* light[], int lightCount);
	void useSpotLight(SpotLight* light[], int lightCount);
